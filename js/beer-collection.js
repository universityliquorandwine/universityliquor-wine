// ============================================
// BEER COLLECTION PAGE JAVASCRIPT
// ============================================
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const animatedElements = document.querySelectorAll(
    '.category-card, .style-card, .pairing-card, .benefit-card, .accordion-item, .faq-item, .fade-in-on-scroll'
  );
  ...
  // ============================================
  const heroBackground = document.querySelector('.beer-hero .hero-background');
  
  if (heroBackground) {
    window.addEventListener('scroll', () => {
      const scrolled = window.pageYOffset;
      const hero = document.querySelector('.beer-hero');
      if (hero) {
